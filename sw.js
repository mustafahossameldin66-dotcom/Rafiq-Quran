const CACHE='rafiq-offline-v11';
const CORE=['./','./index.html','./css/app.css','./css/ambient-effects.css','./css/perfect-architecture.css','./css/ui-overrides.css','./css/memorization-core.css','./js/content-manager.js','./js/app.js','./js/settings.js','./js/ambient-effects.js','./js/mushaf-premium.js','./js/sw-register.js','./js/memorization-engine.js','./quran-uthmani.json','./daily-content.json','./content-manifest.json','./manifest.webmanifest','./assets/icon.svg','./assets/icon-192.png','./assets/icon-512.png'];
