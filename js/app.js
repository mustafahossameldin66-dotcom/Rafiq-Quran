...
let reciters=[
  ...
  {name:'ياسر الدوسري',folder:'curated-'+encodeURIComponent('ياسر الدوسري'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'أحمد طالب بن حميد',folder:'curated-'+encodeURIComponent('أحمد طالب بن حميد'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'أحمد عيسى المعصراوي',folder:'curated-'+encodeURIComponent('أحمد عيسى المعصراوي'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'أحمد نعينع',folder:'curated-'+encodeURIComponent('أحمد نعينع'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'إسلام صبحي',folder:'curated-'+encodeURIComponent('إسلام صبحي'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'الوليد الشمسان',folder:'curated-'+encodeURIComponent('الوليد الشمسان'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'بدر التركي',folder:'curated-'+encodeURIComponent('بدر التركي'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'بندر بليله',folder:'curated-'+encodeURIComponent('بندر بليله'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'توفيق الصايغ',folder:'curated-'+encodeURIComponent('توفيق الصايغ'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'خالد الشريمي',folder:'curated-'+encodeURIComponent('خالد الشريمي'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'رعد الكردي',folder:'curated-'+encodeURIComponent('رعد الكردي'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'سعد الغامدي',folder:'curated-'+encodeURIComponent('سعد الغامدي'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'سعود الشريم',folder:'curated-'+encodeURIComponent('سعود الشريم'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'أبو بكر الشاطري',folder:'curated-'+encodeURIComponent('أبو بكر الشاطري'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'صالح آل طالب',folder:'curated-'+encodeURIComponent('صالح آل طالب'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'عبد الرحمن السديس',folder:'curated-'+encodeURIComponent('عبد الرحمن السديس'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'عبدالله القرافي',folder:'curated-'+encodeURIComponent('عبدالله القرافي'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'عبدالله الكندري',folder:'curated-'+encodeURIComponent('عبدالله الكندري'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'عبدالله موسى',folder:'curated-'+encodeURIComponent('عبدالله موسى'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'علي جابر',folder:'curated-'+encodeURIComponent('علي جابر'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'ماهر المعيقلي',folder:'curated-'+encodeURIComponent('ماهر المعيقلي'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'محمد أيوب',folder:'curated-'+encodeURIComponent('محمد أيوب'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'محمد اللحيدان',folder:'curated-'+encodeURIComponent('محمد اللحيدان'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'محمد جبريل',folder:'curated-'+encodeURIComponent('محمد جبريل'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'محمود علي البنا',folder:'curated-'+encodeURIComponent('محمود علي البنا'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'مشاري العفاسي',folder:'curated-'+encodeURIComponent('مشاري العفاسي'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'مصطفى إسماعيل',folder:'curated-'+encodeURIComponent('مصطفى إسماعيل'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'ناصر القطامي',folder:'curated-'+encodeURIComponent('ناصر القطامي'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'هيثم الدخين',folder:'curated-'+encodeURIComponent('هيثم الدخين'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'وديع اليمني',folder:'curated-'+encodeURIComponent('وديع اليمني'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'},
  {name:'يونس اسويلص',folder:'curated-'+encodeURIComponent('يونس اسويلص'),source:'pending',quality:'بانتظار ربط MP3Quran',mode:'surah'}
];
...
function normalizeMp3QuranReciters(payload){
  const rows=Array.isArray(payload?.reciters)?payload.reciters:[];
  const out=[];
  for(const row of rows){
    const moshafs=Array.isArray(row?.moshaf)?row.moshaf:[];
    const candidates=moshafs.filter(m=>m?.server&&m?.surah_list);
    if(!candidates.length)continue;
    const m=candidates.find(x=>Number(x.surah_total)>=100 && /حفص|Hafs/i.test(String(x.name||'')))
      || candidates.find(x=>Number(x.surah_total)>=100)
      || candidates[0];
    const surahs=String(m.surah_list||'').split(',').map(Number).filter(n=>n>=1&&n<=114);
    if(!surahs.length)continue;
    out.push({
      name:String(row.name||'قارئ بدون اسم').trim(),
      folder:`mp3quran-${row.id}-${m.id}`,
      source:'mp3quran',
      server:String(m.server).replace(/\/+$/,'')+'/',
      quality:`MP3Quran · ${m.name||'تلاوة'}`,
      mode:'surah',
  ...
  for(const r of out){const key=r.folder;if(seen.has(key))continue;seen.add(key);dedup.push(r)}
...
async function loadMp3QuranReciters(){
  const normalizeList=(payload)=>{
    ...
    for(const row of rows){
      ...
      const candidates=moshafs.filter(m=>m?.server&&m?.surah_list);
      if(!candidates.length)continue;
      const m=candidates.find(x=>Number(x.surah_total)>=100)||candidates[0];
      const surahs=String(m.surah_list||'').split(',').map(Number).filter(n=>n>=1&&n<=114);
      if(!surahs.length)continue;
      out.push({name:String(row.name||row.reciter_name||'قارئ').trim(),folder:`mp3quran-${row.id||Math.random()}`,source:'mp3quran',server:String(m.server).replace(/\/$/,'')+'/',quality:`MP3Quran · ${m.name||'تلاوة'}`,mode:'surah',availableSurahs:surahs,reciterId:row.id,moshafId:m.id,readName:m.name||''});
    }
    const seen=new Set(),dedup=[];for(const r of out){const k=r.folder;if(!seen.has(k)){seen.add(k);dedup.push(r)}}
    dedup.sort((a,b)=>mp3ReciterScore(a.name)-mp3ReciterScore(b.name)||a.name.localeCompare(b.name,'ar'));
    return dedup;
  };
  const applyDynamic=(dynamic,sourceLabel)=>{
    ...
    syncRecitationControl();renderRecitations();updateQuranReciterButton();
...
async function resolvePendingReciter(r){
  if(!r||r.source!=='pending')return r;
  try{
    const resp=await fetch(MP3QURAN_RECITER_API,{cache:'no-store',mode:'cors'});
    if(!resp.ok)throw new Error();
    const list=normalizeMp3QuranReciters(await resp.json());
    const target=String(r.name||'').trim();
    const found=list.find(x=>x.name===target)||list.find(x=>target.includes(x.name)||x.name.includes(target));
    if(found){
      const idx=reciters.findIndex(x=>x.name===target);
      if(idx>=0)reciters[idx]=found;
      window.RAFIQ_RECITERS=reciters;
      try{localStorage.setItem('rafiq-mp3quran-reciters-v2',JSON.stringify(reciters.filter(x=>x.source==='mp3quran')))}catch{}
      syncRecitationControl();renderRecitations();updateQuranReciterButton();return found;
    }
  }catch{}
  const cached=readLocalJson('rafiq-mp3quran-reciters-v2');
  if(Array.isArray(cached)){const found=cached.find(x=>x.name===r.name);if(found)return found;}
  return r;
}
...
  try{await qAudio.play(); $('#floatingPlayer').classList.add('active'); updatePlayer(); syncRecitationControl(); toast(`بدأت تلاوة ${s.name} · ${reciter.name} ✨`);}catch(e){window.isAudioPlaying=false;$('#floatingPlayer').classList.add('active');updatePlayer();toast(navigator.onLine?'تعذر تشغيل الملف الصوتي من المصدر؛ جرّب قارئًا آخر أو انتظر تحديث القائمة.':'التلاوة الصوتية تحتاج اتصالًا بالإنترنت أو ملفًا محملًا مسبقًا.')}
}
...
async function loadQuran(){
  ...
  const localEmbedded=Array.isArray(window.RAFIQ_LOCAL_QURAN)?window.RAFIQ_LOCAL_QURAN:null;
  const dbOpen=()=>new Promise((resolve,reject)=>{try{const r=indexedDB.open('rafiq-data',2);r.onupgradeneeded=()=>{const db=r.result;if(!db.objectStoreNames.contains('cache'))db.createObjectStore('cache');};r.onsuccess=()=>resolve(r.result);r.onerror=()=>reject(r.error)}catch(e){reject(e)}});
  ...
  // Embedded Quran is the primary source so the Mushaf also works from file:// and with no network.
  if(localEmbedded&&localEmbedded.length===114){quran=localEmbedded; dbPut(quran);}
  else {
    try{
      const local=await fetch('quran-uthmani.json',{cache:'force-cache'});
      if(local.ok)quran=await local.json(); else throw new Error('local');
      dbPut(quran);
    }catch{
      const cached=await dbGet();
      if(cached&&Array.isArray(cached)&&cached.length===114)quran=cached;
      else {toast('تعذر تجهيز بيانات المصحف المحلية');renderHifz();return;}
    }
  }
  if(!Array.isArray(quran)||quran.length!==114||quran.reduce((n,s)=>n+(Array.isArray(s.verses)?s.verses.length:0),0)!==6236){toast('بيانات المصحف غير مكتملة');return;}
  atharIndex=Math.floor(Date.now()/86400000)%Math.max(1,buildDynamicAthars().length);
  renderAthar(atharIndex);renderSurahGrid();renderQuran();renderRecitations();updateHome();renderHifz();renderPlan();renderMemorizationSummary();renderProgressDashboard();restoreAudioState();window.dispatchEvent(new CustomEvent('rafiq-quran-ready'));setTimeout(()=>window.dispatchEvent(new CustomEvent('rafiq-quran-ready')),250);
}
...
function renderRecitations(){
  ...
  const pool=query?reciters.filter(r=>r.name.toLocaleLowerCase('ar').includes(query)):reciters.slice(0,24);
  ...
  $$('#audioGrid [data-select-reciter]').forEach(b=>b.onclick=async()=>{let r=reciters[Number(b.dataset.selectReciter)];r=await resolvePendingReciter(r);selectReciter(r);toast(`تم اختيار القارئ: ${r.name}`);});
  $$('#audioGrid [data-play-reciter]').forEach(b=>b.onclick=async()=>{const i=Number(b.dataset.playReciter);let r=reciters[i];r=await resolvePendingReciter(r);const select=$(`#reciterSurah-${i}`);selectReciter(r);const surah=Number(select?.value||currentSurah);recitationControl.surah=surah;recitationControl.ayah=1;syncRecitationControl();playRecitation(r,surah,0);});
...
function dailyGreetingText(){
  ...
  if(h<5) return `ليلة طيبة${who} مع رفيق القرآن`;
...
function renderDailyHome(){
  ...
  const reasonPool=[
    ...
    {title:'السياق ليس سبب النزول',text:'قد تكون الآية واردة في سياق معين يساعد على فهمها من غير أن يكون هذا السياق نفسه سبب نزول خاصًا. لذلك نقرأ الآية مع ما قبلها وما بعدها، ثم نبحث عن الرواية إن وُجدت، ولا نستبدل سياق السورة بقصة غير موثقة.',ref:'منهج التحقق داخل رفيق القرآن.'}
  ];
...
function dailyFallback(key){
  ...
  return {key,source:'local-fallback',fetchedAt:Date.now(),verse,hadith:had,dua,qudsi:DAILY_QUDSI};
}
