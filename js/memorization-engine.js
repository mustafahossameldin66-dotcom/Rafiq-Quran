...
(() => {
  ...
  function injectUI(){
    ...
    $('#saveWeeklyReview')?.addEventListener('click',()=>setWeeklyReviewConfig({enabled:true,distribution:$('#weeklyReviewDistribution')?.value||'smart'}));
